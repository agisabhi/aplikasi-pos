              ...
              <div class="row items-push">
                  ...
                  <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        ...
                        <a class="h6" href="be_pages_ecom_store_product.html">Super Badges Pack</a>
                      </div>
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="block block-rounded h-100 mb-0">
                    <div class="block-content p-1">
                      <div class="options-container">
                        <img class="img-fluid options-item" src="assets/media/various/ecom_product12.png" alt="">
                        <div class="options-overlay bg-black-75">
                          <div class="options-overlay-content">
                            <a class="btn btn-sm btn-alt-secondary" href="be_pages_ecom_store_product.html">
                              View
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        <div class="fw-semibold float-end ms-1">$22</div>
                        <a class="h6" href="be_pages_ecom_store_product.html">e-Music</a>
                      </div>
                      <p class="fs-sm text-muted">Music streaming service</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="block block-rounded h-100 mb-0">
                    <div class="block-content p-1">
                      <div class="options-container">
                        <img class="img-fluid options-item" src="assets/media/various/ecom_product4.png" alt="">
                        <div class="options-overlay bg-black-75">
                          <div class="options-overlay-content">
                            <a class="btn btn-sm btn-alt-secondary" href="be_pages_ecom_store_product.html">
                              View
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        <div class="fw-semibold float-end ms-1">$15</div>
                        <a class="h6" href="be_pages_ecom_store_product.html">Steam Games</a>
                      </div>
                      <p class="fs-sm text-muted">3-in-1 Adventure Pack</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        ...
                        <a class="h6" href="be_pages_ecom_store_product.html">MapNow</a>
                      </div>
                  ...
                  <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        ...
                        <a class="h6" href="be_pages_ecom_store_product.html">Calendious</a>
                      </div>
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="block block-rounded h-100 mb-0">
                    <div class="block-content p-1">
                      <div class="options-container">
                        <img class="img-fluid options-item" src="assets/media/various/ecom_product8.png" alt="">
                        <div class="options-overlay bg-black-75">
                          <div class="options-overlay-content">
                            <a class="btn btn-sm btn-alt-secondary" href="be_pages_ecom_store_product.html">
                              View
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        <div class="fw-semibold float-end ms-1">$17</div>
                        <a class="h6" href="be_pages_ecom_store_product.html">Antivir</a>
                      </div>
                      <p class="fs-sm text-muted">Antivirus protection for all</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        ...
                        <a class="h6" href="be_pages_ecom_store_product.html">RPG Game Pack</a>
                      </div>
